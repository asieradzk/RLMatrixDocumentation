...
<details>
    ...
    2. **Uczenie zgodne z polityką (on-policy)**: PPO uczy się tylko z najnowszych doświadczeń używając bieżącej polityki, a następnie je odrzuca. Dlatego posiadanie większej liczby wsadów niż środowisk jest korzystne – daje algorytmowi bardziej zróżnicowane dane do nauki.
