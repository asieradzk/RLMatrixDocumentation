...
<details>
    ...
    2. **On-Policy-Lernen**: PPO lernt nur aus den neuesten Erfahrungen mit der aktuellen Policy und verwirft sie dann. Deshalb ist es vorteilhaft, mehr Batches als Umgebungen zu haben – es gibt dem Algorithmus vielfältigere Daten zum Lernen.
